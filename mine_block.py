...
r = requests.post("http://127.0.0.1:8551", json={"jsonrpc":"2.0","id":1,"method":"engine_forkchoiceUpdatedV3","params":[{"headBlockHash": b, "safeBlockHash": b, "finalizedBlockHash": b}, attr]}, headers=h).json()
print(f"RESULT: {r}")
